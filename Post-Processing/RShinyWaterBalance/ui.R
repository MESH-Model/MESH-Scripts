# This is the user-interface definition of a Shiny web application to plot the water balance variables from the "Basin_average_water_balance.csv" file output from MESH
...
pathR <- "C:/Path/To/Folder/Containing/output/water/balance/file" # Specify the folder name only; the script will read the files
files <- list.files(pathR, pattern = "water",full.names = TRUE,recursive=TRUE)
